...
PasswordHelper.prototype.encrypt = function( plaintext_password, options, callback ) {
	...
	.then( function(options) {
		...
		return pbkdf2( plaintext_password, options.salt, options.iterations, this.key_length );
	})
	.then( function(key) {
		return {
