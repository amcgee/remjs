...
Authenticator.prototype.login = function(req, res, next) {
  ...
  var identity = this.loginHelper.check( req.body.login, req.body.password )
  .bind(this)
...
Authenticator.prototype.signup = function(req, res) {
  ...
  .then( function(identity) {
	...
	.catch( LoginHelper.LoginAlreadyExistsError, function( e ) {
...
Authenticator.prototype.meRouter = function() {
	...
	meRouter.post( "/_password", function(req, res) {
		...
		.catch( LoginHelper.BadPasswordError, function(e) {
