...
var Authenticator = function(resources, options) {
    ...
    // this is a faux-resource which is an alias to the logged-in identity
    this.options.me_path = this.options.me_path || "/me";
...
Authenticator.prototype.meRouter = function() {
    ...
    meRouter.post( "/_password", function(req, res) {
        ...
        this.loginHelper.update(
            req.rem.identity[this.loginHelper.authority.login_property],
